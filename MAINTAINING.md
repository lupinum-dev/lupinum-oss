...
wiring. It recognizes the exact `node scripts/check-dependency-policy.mjs` workflow
command and follows leading pnpm script calls through simple `&&` chains, rejects cycles,
