...
- [ ] The protected workflow was dispatched with explicit `allow_bootstrap` authorization.
...
- [ ] `publish.yml` was dispatched for the bootstrap version after trust was configured.
