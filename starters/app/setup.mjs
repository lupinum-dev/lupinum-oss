...
if (args.includes('--help')) {
  console.log('Usage: node starters/app/setup.mjs --output <empty-dir> --name <slug> --title <title> --description <text> --repository lupinum-dev/<slug> --domain <slug>.lupinum.com --plausible <id>')
  process.exit(0)
}
...
if (values.has('package')) throw new Error('The app profile does not publish an npm package. Remove --package.')
